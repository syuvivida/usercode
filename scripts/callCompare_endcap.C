...
//   std::string treeName2 = "Analysis";
  ...
  compareTwoTrees(dataF,mcF,"PHOLEAD_preshowerEnergy",decCode,"esenergy"+tempName,100,0,10.0,"Preshower E(#gamma) [GeV]","");
  ...
  compareTwoTrees(dataF,mcF,"PHOLEAD_energy",decCode,"energy"+tempName,100,0.,100.,"E(#gamma) [GeV]","");
  ...
  compareTwoTrees(dataF,mcF,"PHOLEAD_rawEnergy",decCode,"rawenergy"+tempName,100,0.,100.,"SC raw energy [GeV]","");
  ...
  compareTwoTrees(dataF,mcF,"PHOLEAD_e3x3",decCode,"sce3x3"+tempName,100,0,100.0,"e3x3 [GeV]","");

  compareTwoTrees(dataF,mcF,"PHOLEAD_e4x4",decCode,"sce4x4"+tempName,100,0,100.0,"e4x4 [GeV]","");

  compareTwoTrees(dataF,mcF,"PHOLEAD_e5x5",decCode,"sce5x5"+tempName,100,0,100.0,"e5x5 [GeV]","");
  ...
  compareTwoTrees(dataF,mcF,"PHOLEAD_ecalIso",decCode,"patecaliso"+tempName,45,-2.0,7.0,"PAT ecalIso [GeV]","");


  compareTwoTrees(dataF,mcF,"PHOLEAD_ecalRecHitSumEtConeDR04",decCode,"ecaliso04"+tempName,45,-2.0,7.0,"ecalRecHitSumEtConeDR04 [GeV]","");
