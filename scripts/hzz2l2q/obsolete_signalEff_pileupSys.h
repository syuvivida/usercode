...
#ifndef obsolete_signalEff_pileupSys_h
#define obsolete_signalEff_pileupSys_h
...
class obsolete_signalEff_pileupSys {
public :
   ...
   obsolete_signalEff_pileupSys(string filename, TTree *tree=0);
   virtual ~obsolete_signalEff_pileupSys();
...
#ifdef obsolete_signalEff_pileupSys_cxx
obsolete_signalEff_pileupSys::obsolete_signalEff_pileupSys(string filename, TTree *tree) : fChain(0) 
{
...
obsolete_signalEff_pileupSys::~obsolete_signalEff_pileupSys()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t obsolete_signalEff_pileupSys::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t obsolete_signalEff_pileupSys::LoadTree(Long64_t entry)
{
...
void obsolete_signalEff_pileupSys::Init(TTree *tree)
{
...
Bool_t obsolete_signalEff_pileupSys::Notify()
{
...
void obsolete_signalEff_pileupSys::Show(Long64_t entry)
{
...
Int_t obsolete_signalEff_pileupSys::Cut(Long64_t entry)
{
...
#endif // #ifdef obsolete_signalEff_pileupSys_cxx
