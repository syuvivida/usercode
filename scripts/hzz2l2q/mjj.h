...
public :
   ...
   mjj(string filename, TTree *tree=0);
   virtual ~mjj();
...
#ifdef mjj_cxx
mjj::mjj(string filename, TTree *tree)
{
...
Int_t mjj::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t mjj::LoadTree(Long64_t entry)
{
