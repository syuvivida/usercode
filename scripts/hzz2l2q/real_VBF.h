...
// Tue Oct 23 14:49:15 2012 by ROOT version 5.32/00
// from TTree tree/tree
// found on file: real_VBF_8TeV_125_52X.root
//////////////////////////////////////////////////////////
...
public :
   ...
   real_VBF(string filename, TTree *tree=0);
   virtual ~real_VBF();
   ...
   virtual Bool_t   matchPartonToGenJet(Int_t igen, Int_t ijet);
   virtual TLorentzVector setParticleL4(Int_t igen);
   virtual TLorentzVector setGenJetL4(Int_t ijet);
...
#ifdef real_VBF_cxx
real_VBF::real_VBF(string filename, TTree *tree)
{
...
Int_t real_VBF::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t real_VBF::LoadTree(Long64_t entry)
{
...
void real_VBF::Show(Long64_t entry)
{
...
Int_t real_VBF::Cut(Long64_t entry)
{
