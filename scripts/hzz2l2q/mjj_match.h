...
public :
   ...
   mjj_match(string filename, TTree *tree=0);
   virtual ~mjj_match();
...
#ifdef mjj_match_cxx
mjj_match::mjj_match(string filename, TTree *tree)
{
...
Int_t mjj_match::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t mjj_match::LoadTree(Long64_t entry)
{
...
void mjj_match::Init(TTree *tree)
{
...
void mjj_match::Show(Long64_t entry)
{
...
Int_t mjj_match::Cut(Long64_t entry)
{
