...
TCut rsLooseCutEB = "pt > 15.0 && abs(eta)<1.45 && hadronicOverEm <  0.05 && (ecalRecHitSumEtConeDR04+hcalTowerSumEtConeDR04+trkSumPtHollowConeDR04) < 11.0";
TCut rsLooseCutEE = "pt > 15.0 && abs(eta) > 1.7 && abs(eta) < 2.5 && hadronicOverEm <  0.05 && (ecalRecHitSumEtConeDR04+hcalTowerSumEtConeDR04+trkSumPtHollowConeDR04) < 11.0";
