...
#ifndef reco_vector_angular_h
#define reco_vector_angular_h
...
public :
   ...
   reco_vector_angular(std::string filename, TTree *tree=0);
   virtual ~reco_vector_angular();
...
#ifdef reco_vector_angular_cxx
reco_vector_angular::reco_vector_angular(std::string filename, TTree *tree)
{
...
reco_vector_angular::~reco_vector_angular()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t reco_vector_angular::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t reco_vector_angular::LoadTree(Long64_t entry)
{
...
void reco_vector_angular::Init(TTree *tree)
{
...
Bool_t reco_vector_angular::Notify()
{
...
void reco_vector_angular::Show(Long64_t entry)
{
...
Int_t reco_vector_angular::Cut(Long64_t entry)
{
...
#endif // #ifdef reco_vector_angularx_cxx
