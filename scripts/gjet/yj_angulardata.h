...
// Wed Feb  8 12:33:16 2012 by ROOT version 5.27/06b
// from TTree tree/tree
// found on file: /data4/yunju/NewtreeT/Data/TreeMay10ReReco_2_4_T/Phojtree_1_3_ORB.root
//////////////////////////////////////////////////////////

#ifndef yj_angulardata_h
#define yj_angulardata_h
...
public :
   ...
   yj_angulardata(std::string dirName, TTree *tree=0);
   virtual ~yj_angulardata();
...
#ifdef yj_angulardata_cxx
yj_angulardata::yj_angulardata(std::string dirName, TTree *tree)
{
...
yj_angulardata::~yj_angulardata()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t yj_angulardata::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t yj_angulardata::LoadTree(Long64_t entry)
{
...
void yj_angulardata::Init(TTree *tree)
{
...
void yj_angulardata::Show(Long64_t entry)
{
...
Int_t yj_angulardata::Cut(Long64_t entry)
{
...
#endif // #ifdef yj_angulardata_cxx
