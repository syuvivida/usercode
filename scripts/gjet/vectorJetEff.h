...
// Tue Aug 30 10:55:57 2011 by ROOT version 5.27/06b
// from TTree tree/tree
// found on file: /data2/syu/anilNtuple/pfJet_QCD_Pt_15_TuneZ2_2760GeV-pythia6.root
//////////////////////////////////////////////////////////
...
using namespace std;
   ...
   const Int_t kMaxpatJetPFlowNConstituents = 1;
...
public :
   ...
   vector<int>     *patJetPFlowNConstituents_;
   ...
   TBranch        *b_patJetPFlowNConstituents_;   //!
   ...
   vectorJetEff(std::string inputFile);
...
vectorJetEff::vectorJetEff(std::string inputFile)
{
...
void vectorJetEff::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("patJetPFlowNConstituents_", &patJetPFlowNConstituents_, &b_patJetPFlowNConstituents_);
