...
// Wed Mar  7 10:17:39 2012 by ROOT version 5.27/06b
// from TTree tree/tree
// found on file: /data4/syu/7TeV_vectorNtuple/pythia/QCD_Pt-30to50_TuneZ2_7TeV_pythia6.root
//////////////////////////////////////////////////////////

#ifndef vectorJetEff_h
#define vectorJetEff_h
...
//   const Int_t kMaxpatJetPfAk05JECUncert = 1;
...
public :
   ...
   //   vector<double>  *patJetPfAk05JECUncert_;
   ...
   //   TBranch        *b_patJetPfAk05JECUncert_;   //!
   ...
   vectorJetEff(string filename, TTree *tree=0);
   virtual ~vectorJetEff();
...
#ifdef vectorJetEff_cxx
vectorJetEff::vectorJetEff(string filename, TTree *tree)
{
...
vectorJetEff::~vectorJetEff()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t vectorJetEff::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t vectorJetEff::LoadTree(Long64_t entry)
{
...
void vectorJetEff::Init(TTree *tree)
{
...
//    fChain->SetBranchAddress("EvtInfo_vertexNdof", &EvtInfo_vertexNdof, &b_EvtInfo_vertexNdof);
   ...
   //   fChain->SetBranchAddress("patJetPfAk05JECUncert_", &patJetPfAk05JECUncert_, &b_patJetPfAk05JECUncert_);
...
void vectorJetEff::Show(Long64_t entry)
{
...
Int_t vectorJetEff::Cut(Long64_t entry)
{
