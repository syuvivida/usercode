...
// Tue Jan 17 07:10:24 2012 by ROOT version 5.27/06b
// from TTree EventTree/Event data
// found on file: test.root
// ggNtuple replica of angular efficiency
//
//////////////////////////////////////////////////////////
...
public :
   ...
   debugCount(std::string dirName, TTree *tree=0);
   virtual ~debugCount();
...
#ifdef debugCount_cxx
debugCount::debugCount(std::string dirName, TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {

     TChain* pho = new TChain("ggNtuplizer/EventTree");
     ...
     while(fileH = (TFile*)fileIt()) {
       ...
       std::string baseString = "ggtree_data";
...
Int_t debugCount::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t debugCount::LoadTree(Long64_t entry)
{
...
void debugCount::Init(TTree *tree)
{
...
void debugCount::Show(Long64_t entry)
{
...
Int_t debugCount::Cut(Long64_t entry)
{
