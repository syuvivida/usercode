...
//    fjActiveArea.set_fj2_placement(true);
    ...
    out_jets_ = sorted_by_pt(thisClustering_->inclusive_jets(50.0));
    out_jets_wGhosts_ = sorted_by_pt(thisClustering_wGhosts_->inclusive_jets(50.0));    
    out_jets_basic_ = sorted_by_pt(thisClustering_basic_->inclusive_jets(50.0));
...
double JetSubstructureTools::getJetCharge( float kappa ){
    ...
    std::vector<fastjet::PseudoJet> constits = FJconstituents_;
    std::vector<float> pdgIds = c_pdgIds_;
