...
void easyMatchTrigEff(std::string filestring, 
		      bool isBarrel, bool applyR9)
{

  std::string detector  = isBarrel? "barrel" : "endcap";
  std::string R9name    = applyR9?  "R9"     : "default";  
  std::string fileName = "/home/syu/Photon_Code/CMSSW_3_1_2/src/syu/MyObjectCounter/test/script_output/test_" + filestring + "_" + detector +  "_" + R9name
    + ".root";
  ...
  title[6]="HLT_Photon15_L1R/HLT_L1SingleEG8 (photon from hard scattering)";
  ...
  title[10]="HLT_L1SingleEG8/reconstructed photon (photons from hard scattering or jets)";
  ...
  std::string outFileName = "/home/syu/Photon_Code/CMSSW_3_1_2/src/syu/MyObjectCounter/test/script_output/trigeff_" + filestring + "_" + detector +  "_" + R9name
    + ".root";
