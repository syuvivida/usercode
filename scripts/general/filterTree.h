...
// Sun Jun  1 14:13:18 2014 by ROOT version 5.34/18
// from TTree EventTree/Event data
// found on file: ../job_summer12_DYJetsToLL.root
//////////////////////////////////////////////////////////
...
public :
   ...
   filterTree(std::string name,TTree *tree=0);
   virtual ~filterTree();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(int skimMode=0);
...
#ifdef filterTree_cxx
filterTree::filterTree(std::string name, TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
	...
	f = new TFile(inputFile_.data());
      ...
      TDirectory * dir = (TDirectory*)f->Get(Form("%s/ggNtuplizer",inputFile_.data()));
...
Int_t filterTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t filterTree::LoadTree(Long64_t entry)
{
...
void filterTree::Init(TTree *tree)
{
...
void filterTree::Show(Long64_t entry)
{
...
Int_t filterTree::Cut(Long64_t entry)
{
