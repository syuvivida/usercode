...
void callCompare_barrel()
{
  ...
  compareTwoTrees(dataF,mcF,"PHOLEAD_energy",decCode,"energy_900GeV",25,0.,25.,"E(#gamma) [GeV]","");


  compareTwoTrees(dataF,mcF,"PHOLEAD_pt",decCode,"pt_900GeV",20,0.,20.,"p_{T}(#gamma) [GeV/c]","");


  compareTwoTrees(dataF,mcF,"PHOLEAD_eta",decCode,"eta_900GeV",40,-3.,5.,"#eta(#gamma) ","");
  ...
  compareTwoTrees(dataF,mcF,"PHOLEAD_rawEnergy",decCode,"rawenergy_900GeV",25,0.,25.,"SC raw energy [GeV]","");
  ...
  compareTwoTrees(dataF,mcF,"PHOLEAD_phiWidth",decCode,"scphiwidth_900GeV",32,0,0.16,"SC #phi width","");

  compareTwoTrees(dataF,mcF,"PHOLEAD_etaWidth",decCode,"scetawidth_900GeV",25,0,0.04,"SC #eta width","");

  compareTwoTrees(dataF,mcF,"PHOLEAD_eMax",decCode,"sceMax_900GeV",25,0,25.0,"Energy of most energetic crystal [GeV]","");

  compareTwoTrees(dataF,mcF,"PHOLEAD_e2nd",decCode,"sce2nd_900GeV",10,0,5.0,"Energy of second energetic crystal [GeV]","");


  compareTwoTrees(dataF,mcF,"PHOLEAD_eMax/PHOLEAD_e3x3", decCode,"sceSpikeRatio",50,0.0,2.0,"eMax/e3x3","");

  compareTwoTrees(dataF,mcF,"PHOLEAD_e2x2",decCode,"sce2x2_900GeV",30,0,30.0,"e2x2 [GeV]","");

  compareTwoTrees(dataF,mcF,"PHOLEAD_e3x3",decCode,"sce3x3_900GeV",30,0,30.0,"e3x3 [GeV]","");

  compareTwoTrees(dataF,mcF,"PHOLEAD_e4x4",decCode,"sce4x4_900GeV",30,0,30.0,"e4x4 [GeV]","");

  compareTwoTrees(dataF,mcF,"PHOLEAD_e5x5",decCode,"sce5x5_900GeV",30,0,30.0,"e5x5 [GeV]","");

  compareTwoTrees(dataF,mcF,"PHOLEAD_covPhiPhi",decCode,"covphiphi_900GeV",20,0,0.001,"covPhiPhi","");

  compareTwoTrees(dataF,mcF,"PHOLEAD_covEtaPhi",decCode,"covetaphi_900GeV",30, -0.001,0.002,"covEtaPhi","");

  compareTwoTrees(dataF,mcF,"PHOLEAD_covEtaEta",decCode,"covetaeta_900GeV",20,0,0.001,"covEtaEta","");

  compareTwoTrees(dataF,mcF,"PHOLEAD_sigmaEtaEta",decCode,"sigetaeta_900GeV",20,0,0.05,"#sigma_{#eta#eta}","");

  compareTwoTrees(dataF,mcF,"PHOLEAD_sigmaIetaIeta",decCode,"sigietaieta_900GeV",20,0,0.05,"#sigma_{i#etai#eta}","");
  ...
  compareTwoTrees(dataF,mcF,"PHOLEAD_ecalIso",decCode,"patecaliso_900GeV",55,-1.0,10.0,"PAT ecalIso [GeV]","");

  compareTwoTrees(dataF,mcF,"PHOLEAD_hcalIso",decCode,"pathcaliso_900GeV",55,-1.0,10.0,"PAT hcalIso [GeV]","");


  compareTwoTrees(dataF,mcF,"PHOLEAD_ecalRecHitSumEtConeDR04",decCode,"ecaliso04_900GeV",55,-1.0,10.0,"ecalRecHitSumEtConeDR04 [GeV]","");
