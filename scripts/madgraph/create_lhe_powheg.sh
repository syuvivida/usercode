...
#cp -p /afs/cern.ch/work/s/syu/MyPowHeg/CMSSW_5_3_9/src/Configuration/GenProduction/python/EightTeV/DYToMuMu_M-20_CT10_8TeV-powheg.input powheg.input
cp -p /afs/cern.ch/work/s/syu/MyPowHeg/CMSSW_5_3_9/src/Configuration/GenProduction/python/EightTeV/WplusToENu_CT10_8TeV-powheg.input powheg.input
...
sed 's/PDF=lhapdf /PDF=lhapdf/g' Makefile.temp >Makefile
