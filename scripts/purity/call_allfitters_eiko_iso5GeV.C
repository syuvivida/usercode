...
void call_allfitters_eiko_iso5GeV(bool fitData=false, bool doEffCorr=false, double lumi=8.02){
...
//   std::string templateFile = fitData? "template_sumIso_histo.root": "template_sumIso_histo.root";
  ...
  c1->SaveAs("plots/allfitter_purity_EB_iso5GeV.eps");
  c1->SaveAs("plots/allfitter_purity_EB_iso5GeV.gif"); 
  c1->SaveAs("plots/allfitter_purity_EB_iso5GeV.pdf");
  c1->SaveAs("plots/allfitter_purity_EB_iso5GeV.C");
  ...
  c2->SaveAs("plots/allfitter_purity_EE_iso5GeV.eps");
  c2->SaveAs("plots/allfitter_purity_EE_iso5GeV.gif");
  c2->SaveAs("plots/allfitter_purity_EE_iso5GeV.pdf");
  c2->SaveAs("plots/allfitter_purity_EE_iso5GeV.C");
  ...
  c3->SaveAs("plots/allfitter_yield_EB_iso5GeV.eps");
  c3->SaveAs("plots/allfitter_yield_EB_iso5GeV.gif");
  c3->SaveAs("plots/allfitter_yield_EB_iso5GeV.pdf");
  c3->SaveAs("plots/allfitter_yield_EB_iso5GeV.C");
  ...
  c4->SaveAs("plots/allfitter_yield_EE_iso5GeV.eps");
  c4->SaveAs("plots/allfitter_yield_EE_iso5GeV.gif");
  c4->SaveAs("plots/allfitter_yield_EE_iso5GeV.pdf");
  c4->SaveAs("plots/allfitter_yield_EE_iso5GeV.C");
