...
void call_allfitters_MCtest(){
  ...
  TGraphErrors *tgrs_purity_EB = new TGraphErrors(nPtBin, fBinsPtMidPoint, purity_func[0], fBinsPtError, purity_err_func[0]);
  ...
  TGraphErrors *tgrs_purity_template_EB = new TGraphErrors(nPtBin, fBinsPtMidPoint, purity_template[0], fBinsPtError, purity_err_template[0]);
  ...
  TGraphErrors *tgrs_purity_twobin_EB = new TGraphErrors(nPtBin, fBinsPtMidPoint, purity_2bin[0], fBinsPtError, purity_err_2bin[0]);
  ...
  TGraphErrors *tgrs_purity_EE = new TGraphErrors(nPtBin, fBinsPtMidPoint, purity_func[1], fBinsPtError, purity_err_func[1]);
  ...
  TGraphErrors *tgrs_purity_template_EE = new TGraphErrors(nPtBin, fBinsPtMidPoint, purity_template[1], fBinsPtError, purity_err_template[1]);
  ...
  TGraphErrors *tgrs_purity_twobin_EE = new TGraphErrors(nPtBin, fBinsPtMidPoint, purity_2bin[1], fBinsPtError, purity_err_2bin[1]);
  ...
  TGraphErrors *tgrs_sig_EB = new TGraphErrors(nPtBin, fBinsPtMidPoint, nsig_func[0], fBinsPtError, nsig_err_func[0]);
  ...
  TGraphErrors *tgrs_sig_template_EB = new TGraphErrors(nPtBin, fBinsPtMidPoint, nsig_template[0], fBinsPtError, nsig_err_template[0]);
  ...
  TGraphErrors *tgrs_sig_EE = new TGraphErrors(nPtBin, fBinsPtMidPoint, nsig_func[1], fBinsPtError, nsig_err_func[1]);
  ...
  TGraphErrors *tgrs_sig_template_EE = new TGraphErrors(nPtBin, fBinsPtMidPoint, nsig_template[1], fBinsPtError, nsig_err_template[1]);
