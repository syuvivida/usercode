...
// Thu Jun  3 23:22:08 2010 by ROOT version 5.22/00d
// from TTree Analysis/Analysis
// found on file: /data3/ncuhep/QCDPhoton_Ntuple/EGData/EGData_100531.root
//////////////////////////////////////////////////////////
...
public :
   ...
   UChar_t         HLT_MinBiasBSC;
   UChar_t         HLT_MinBiasBSC_NoBPTX;
   UChar_t         HLT_MinBiasBSC_OR;
   Int_t           kMaxTrigFlag;
   Int_t           nHLTBits;
   UChar_t         HLTBit[147];   //[nHLTBits]
   Int_t           nHfTowersP;
   Int_t           nHfTowersN;
   Double_t        beamSpotX;
   Double_t        beamSpotY;
...
#ifdef LoopEvent_cxx
LoopEvent::LoopEvent(std::string filename)
{
  TFile *inf = new TFile(filename.data());
  TTree* tree = (TTree*)inf->FindObjectAny("Analysis");
  Init(tree);
}
...
Int_t LoopEvent::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t LoopEvent::LoadTree(Long64_t entry)
{
...
void LoopEvent::Init(TTree *tree)
{
...
void LoopEvent::Show(Long64_t entry)
{
...
Int_t LoopEvent::Cut(Long64_t entry)
{
