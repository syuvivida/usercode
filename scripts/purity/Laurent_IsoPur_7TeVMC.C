#define Laurent_IsoPur_7TeVMC_cxx
#include "Laurent_IsoPur_7TeVMC.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>
#include <TH1F.h>
...
void Laurent_IsoPur_7TeVMC::Loop(Int_t choiceEB) // 0 all  1 Barrel  2 Transition  3 Endcap
{
  
  // constants, these may vary depending on the samples we use for weighting or fitting
  const Int_t nSignalSamples     = 10;
  const Int_t nBackgroundSamples = 20;
  ...
  for(Int_t i=0;i < SignalTemplateSample_start; i++)xSec[i] = prexSec[i];
  for(Int_t i=SignalTemplateSample_start;i<nSamples;i++)xSec[i] = prexSec[i-SignalTemplateSample_start];
  ...
  Double_t skimEff[nSamples];
  for(int i=0; i < nSamples; i++)skimEff[i] = 1.0;
  for(Int_t i=0;i<nSamples; i++)
  ...
  char fileName[nSamples][1000] = {
    // signal
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/PhotonJet0_15_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/PhotonJet15_20_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/PhotonJet20_30_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/PhotonJet30_50_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/PhotonJet50_80_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/PhotonJet80_120_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/PhotonJet120_170_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/PhotonJet170_300_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/PhotonJet300_500_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/PhotonJet500_Inf_7TeV_MC_combined_data.root",

    // background
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/QCDDiJet0_15_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/QCDDiJet15_20_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/QCDDiJet20_30_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/QCDDiJet30_50_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/QCDDiJet50_80_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/QCDDiJet80_120_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/QCDDiJet120_170_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/QCDDiJet170_230_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/QCDDiJet230_300_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/QCDDiJet300_380_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/QCDDiJet380_470_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/QCDDiJet470_600_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/QCDDiJet600_800_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/QCDDiJet800_1000_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/QCDDiJet1000_1400_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/QCDDiJet1400_1800_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/QCDDiJet1800_2200_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/QCDDiJet2200_2600_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/QCDDiJet2600_3000_7TeV_MC_combined_data.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/data_files/QCDDiJet3000_3500_7TeV_MC_combined_data.root",
    "","","",


    // signal
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/PhotonJet0_15_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/PhotonJet15_20_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/PhotonJet20_30_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/PhotonJet30_50_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/PhotonJet50_80_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/PhotonJet80_120_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/PhotonJet120_170_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/PhotonJet170_300_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/PhotonJet300_500_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/PhotonJet500_Inf_7TeV_MC_combined_template.root",

    // background
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/QCDDiJet0_15_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/QCDDiJet15_20_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/QCDDiJet20_30_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/QCDDiJet30_50_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/QCDDiJet50_80_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/QCDDiJet80_120_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/QCDDiJet120_170_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/QCDDiJet170_230_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/QCDDiJet230_300_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/QCDDiJet300_380_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/QCDDiJet380_470_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/QCDDiJet470_600_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/QCDDiJet600_800_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/QCDDiJet800_1000_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/QCDDiJet1000_1400_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/QCDDiJet1400_1800_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/QCDDiJet1800_2200_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/QCDDiJet2200_2600_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/QCDDiJet2600_3000_7TeV_MC_combined_template.root",
    "/mc/QCD_31x/QCDPhoton_Ntuple/template_files/QCDDiJet3000_3500_7TeV_MC_combined_template.root",
    "","",""
  };
  
  char fileLbl[nSamples][200] = {
    "S015_Data","S1520_Data","S2030_Data","S3050_Data","S5080_Data","S80120_Data","S120170_Data","S170300_Data","S300500_Data","S500Inf_Data",
    "B015_Data","B1520_Data","B2030_Data","B3050_Data","B5080_Data","B80120_Data","B120170_Data","B170230_Data","B230300_Data","B300380_Data","B380470_Data","B470600_Data","B600800_Data","B8001000_Data","B10001400_Data","B14001800_Data","B18002200_Data","B22002600_Data","B26003000_Data","B30003500_Data",    
    "S_Data", "B_Data","SandB_Data",
    "S015_Template","S1520_Template","S2030_Template","S3050_Template","S5080_Template","S80120_Template","S120170_Template","S170300_Template","S300500_Template","S500Inf_Template",
    "B015_Template","B1520_Template","B2030_Template","B3050_Template","B5080_Template","B80120_Template","B120170_Template","B170230_Template","B230300_Template","B300380_Template","B380470_Template","B470600_Template","B600800_Template","B8001000_Template","B10001400_Template","B14001800_Template","B18002200_Template","B22002600_Template","B26003000_Template","B30003500_Template",    
    "S_Template", "B_Template"
  };
  

  Double_t minPtHat[nSamples] = {
    0,15,20,30,50,80,120,170,300,500,
    0,15,20,30,50,80,120,170,230,300,380,470,600,800,1000,1400,1800,2200,2600,3000,
    0,0,0
  };

 for(Int_t i=SignalTemplateSample_start;i<nSamples;i++)minPtHat[i] = minPtHat[i-SignalTemplateSample_start];
  
  Double_t maxPtHat[nSamples] = {
    15,20,30,50,80,120,170,300,500,1e5,
    15,20,30,50,80,120,170,230,300,380,470,600,800,1000,1400,1800,2200,2600,3000,3500,
    0,0,0
  };

 for(Int_t i=SignalTemplateSample_start;i<nSamples;i++)maxPtHat[i] = maxPtHat[i-SignalTemplateSample_start];
 ...
 for(Int_t i=0; i< nPtBin; i++){ 
  ...
  for(Int_t samp=0; samp<nSamples; samp++) {
    ...
    if (TString(fileName[samp])!=""){
      ...
      indepTree[samp] = (TTree*) indepFile[samp]->Get("Analysis");
  ...
  gStyle->SetPadLeftMargin(0.15);
  sprintf(sochn2,"MCCCPurVsPt_%s",nameEB[choiceEB]);
  TCanvas* canPurPt2 = new TCanvas(sochn2,sochn2,800,800);
  if(1) {
    canPurPt2->cd()->SetLogx();
    purMC->GetXaxis()->SetTitle("Photon E_{t} (GeV)");
    sprintf(sochn2,"Photon Purity %",intLum);
    purMC->GetYaxis()->SetTitle(sochn2);
    purMC->SetMinimum(-1);
    ...
    canPurPt2->SaveAs(".gif");
    canPurPt2->SaveAs(".eps");
    canPurPt2->SaveAs(".pdf");
  }
...
Double_t Laurent_IsoPur_7TeVMC::purCCerr(Double_t effB, Double_t effB_N, Double_t effS, Double_t effS_N, Double_t effSnB, Double_t effSnB_N) 
{
...
Double_t Laurent_IsoPur_7TeVMC::purMCerr(Double_t fillS, Double_t scaleS, Double_t fillB, Double_t scaleB) 
{
...
Bool_t Laurent_IsoPur_7TeVMC::CheckFiducial(Int_t choiceEB, Int_t ipho)
{
  if(choiceEB == 1 && !(fabs(scEta[ipho])>0.0  && fabs(scEta[ipho])<=0.9))return false;
  if(choiceEB == 2 && !(fabs(scEta[ipho])>0.9  && fabs(scEta[ipho])<=1.45))return false;
  if(choiceEB == 3 && !(fabs(scEta[ipho])>1.55 && fabs(scEta[ipho])<=2.5))return false;
  return true;

}

Bool_t Laurent_IsoPur_7TeVMC::IsLoosePhoton(Bool_t isQCD, Int_t ipho)
{
