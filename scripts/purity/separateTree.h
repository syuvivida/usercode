...
#ifdef separateTree_cxx
separateTree::separateTree(std::string filename)
{
  inputFile_ = filename;
  TTree* tree;
...
Int_t separateTree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t separateTree::LoadTree(Long64_t entry)
{
...
void separateTree::Init(TTree *tree)
{
...
void separateTree::Show(Long64_t entry)
{
...
Int_t separateTree::Cut(Long64_t entry)
{
