		    ...
		    )
{
  ...
  std::string mcfile[NHISTOS]={
    "biggerBin_matched/partonmatched_mjj_hzz2l2q_M200.root",
    "biggerBin_matched/partonmatched_mjj_hzz2l2q_M300.root",
    "biggerBin_matched/partonmatched_mjj_hzz2l2q_M525.root",
    "biggerBin_matched/partonmatched_mjj_hzz2l2q_M600.root",
    "biggerBin_matched/partonmatched_mjj_hzz2l2q_M700.root",
    "biggerBin_matched/partonmatched_mjj_hzz2l2q_M800.root",
    "biggerBin_matched/partonmatched_mjj_hzz2l2q_M900.root"
  };
  ...
  int COLOR[NHISTOS]={4,1, 2, kOrange-1,kGreen, kBlue, kMagenta};
  int MARKERSTYLE[NHISTOS]={24,21,29,8,25,34,22};
...
//     h[i]->GetYaxis()->SetDecimals();
  ...
  float x1NDC = 0.600806;
  float y1NDC = 0.508136;
  float x2NDC = 0.820565;
...
//   leg->SetHeader(headertitle.data());
  ...
  string dirName = "20120629_biggerBin_matched";
