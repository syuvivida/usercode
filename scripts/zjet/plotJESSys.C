...
void plotJESSys(std::string filename)
{
  ...
  std::string ytitle = "JES Systematics/Central";
  ...
  leg->SetBorderSize(0);
  leg->AddEntry(r_zy_up, "+1 #sigma");
  leg->AddEntry(r_zy_down,"-1 #sigma");
  leg->Draw("same");
  ...
  c1->Print("kengJES/JESsys.eps");
  c1->Print("kengJES/JESsys.gif");
  c1->Print("kengJES/JESsys.pdf");
