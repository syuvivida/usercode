...
#ifndef madgraph_gen_h
#define madgraph_gen_h
...
public :
   ...
   madgraph_gen(std::string filename,TTree *tree=0);
   virtual ~madgraph_gen();
...
#ifdef madgraph_gen_cxx
madgraph_gen::madgraph_gen(std::string filename, TTree *tree)
{
...
madgraph_gen::~madgraph_gen()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t madgraph_gen::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t madgraph_gen::LoadTree(Long64_t entry)
{
...
void madgraph_gen::Init(TTree *tree)
{
...
void madgraph_gen::Show(Long64_t entry)
{
...
Int_t madgraph_gen::Cut(Long64_t entry)
{
