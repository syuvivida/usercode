...
#ifndef pileup_annemarie_h
#define pileup_annemarie_h
...
public :
   ...
   pileup_annemarie(TTree *tree=0);
   virtual ~pileup_annemarie();
...
#ifdef pileup_annemarie_cxx
pileup_annemarie::pileup_annemarie(TTree *tree)
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("/data2/syu/zjet_vectorNtuple/anne-marie_DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola.root");
      if (!f) {
         f = new TFile("/data2/syu/zjet_vectorNtuple/anne-marie_DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola.root");
         f->cd("/data2/syu/zjet_vectorNtuple/anne-marie_DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola.root:/tree");
      }
...
pileup_annemarie::~pileup_annemarie()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t pileup_annemarie::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t pileup_annemarie::LoadTree(Long64_t entry)
{
...
void pileup_annemarie::Init(TTree *tree)
{
...
Bool_t pileup_annemarie::Notify()
{
...
void pileup_annemarie::Show(Long64_t entry)
{
...
Int_t pileup_annemarie::Cut(Long64_t entry)
{
...
#endif // #ifdef pileup_annemarie_cxx
