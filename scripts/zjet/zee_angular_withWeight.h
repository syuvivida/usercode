...
// Fri Mar 30 18:14:31 2012 by ROOT version 5.27/06b
// from TTree tree/tree
// found on file: /data2/syu/obsolete_zjet_mc/new_DYJetsToLL_TuneZ2_M-50_7TeV-madgraph-tauola.root
//////////////////////////////////////////////////////////

#ifndef zee_angular_withWeight_h
#define zee_angular_withWeight_h
...
public :
   ...
   zee_angular_withWeight(string inputFile, TTree *tree=0);
   virtual ~zee_angular_withWeight();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(bool applyWeight=true);
...
#ifdef zee_angular_withWeight_cxx
zee_angular_withWeight::zee_angular_withWeight(string inputFile, TTree *tree)
{
...
// used to generate this class and read the Tree.
  if (tree == 0) {
    ...
    if (!f) {
      ...
      f->cd(Form("%s:/tree",inputFile.data()));
    }
...
zee_angular_withWeight::~zee_angular_withWeight()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t zee_angular_withWeight::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t zee_angular_withWeight::LoadTree(Long64_t entry)
{
...
void zee_angular_withWeight::Init(TTree *tree)
{
...
Bool_t zee_angular_withWeight::Notify()
{
...
void zee_angular_withWeight::Show(Long64_t entry)
{
...
Int_t zee_angular_withWeight::Cut(Long64_t entry)
{
...
#endif // #ifdef zee_angular_withWeight_cxx
