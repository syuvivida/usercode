...
#ifndef angular_parton_h
#define angular_parton_h
...
public :
   ...
   angular_parton(std::string filename,TTree *tree=0);
   virtual ~angular_parton();
   virtual Int_t    Cut(Long64_t entry);
   virtual Int_t    GetEntry(Long64_t entry);
   virtual Long64_t LoadTree(Long64_t entry);
   virtual void     Init(TTree *tree);
   virtual void     Loop(int lepID, bool exclusive=true, 
			 bool applyWeight=true, int DEBUG=0);
...
#ifdef angular_parton_cxx
angular_parton::angular_parton(std::string filename, TTree *tree)
{
  if (tree == 0) {
...
angular_parton::~angular_parton()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t angular_parton::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t angular_parton::LoadTree(Long64_t entry)
{
...
void angular_parton::Init(TTree *tree)
{
...
void angular_parton::Show(Long64_t entry)
{
...
Int_t angular_parton::Cut(Long64_t entry)
{
...
#endif // #ifdef angular_parton_cxx
