...
// Thu Mar 15 17:58:42 2012 by ROOT version 5.27/06b
// from TTree tree/tree
// found on file: Data.root
//////////////////////////////////////////////////////////

#ifndef zee_angular_h
#define zee_angular_h
...
public :
   ...
   zee_angular(string inputFile, TTree *tree=0);
   virtual ~zee_angular();
...
#ifdef zee_angular_cxx
zee_angular::zee_angular(string inputFile, TTree *tree)
{
...
zee_angular::~zee_angular()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t zee_angular::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t zee_angular::LoadTree(Long64_t entry)
{
...
void zee_angular::Init(TTree *tree)
{
...
void zee_angular::Show(Long64_t entry)
{
...
Int_t zee_angular::Cut(Long64_t entry)
{
