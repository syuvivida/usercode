...
namespace Rivet {
  ...
  class CMS_2013_1258128 : public Analysis {
  public:

    //Constructor:
    CMS_2013_1258128()
      : Analysis("CMS_2013_1258128")
    {
	...
	return;
      ...
      _hist1YSum   ->fill(fabs(ysum),weight);
      _hist1YDif   ->fill(fabs(ydif),weight);      
    ...
    void makePhotonCut(const Event& event){
      ...
      _hist2YPhoton  ->fill(fabs(yPhoton),weight);
      _hist2YJet     ->fill(fabs(yjet),weight);
      _hist2YSum     ->fill(fabs(ysum),weight);
      _hist2YDif     ->fill(fabs(ydif),weight);
...
*/
  ...
  AnalysisBuilder<CMS_2013_1258128> plugin_CMS_2013_1258128;
