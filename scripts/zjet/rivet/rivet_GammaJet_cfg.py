...
# with command line options: Configuration/GenProduction/python/G_Pt_30_TuneZ2_7TeV_pythia6_cff.py -s GEN --datatier=GEN-SIM-RAW --conditions auto:mc --eventcontent RAWSIM --no_exec -n 10000 --python_filename=rivet_GammaJet_cfg.py --customise=Configuration/GenProduction/rivet_customize.py
...
process.RAWSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('G_Pt_30_TuneZ2_7TeV_pythia6_cff_py_GEN.root'),
...
process.generator = cms.EDFilter("Pythia6GeneratorFilter",
    ...
    crossSection = cms.untracked.double(171683.2),
