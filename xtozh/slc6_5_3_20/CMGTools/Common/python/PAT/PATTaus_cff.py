...
######## import new Discriminators from https://github.com/cms-tau-pog/cmssw/blob/CMSSW_5_3_X_HighPt/PhysicsTools/PatAlgos/python/tools/tauTools.py#L195
from PhysicsTools.PatAlgos.tools.tauTools import *

newhpsTauIDSources = list()
for element in hpsTauIDSources:
    left = element[0]
    element1_forInputTag = "hpsPFTau" + element[1]
    right = cms.InputTag(element1_forInputTag)
    newelement = (left,right)
    newhpsTauIDSources.append(newelement)

print newhpsTauIDSources
#print tauIDs.items()
...
if 1: 
    ...
    tauIDs = dict( newhpsTauIDSources )
